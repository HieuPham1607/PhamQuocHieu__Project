    ...
    public partial class v1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ADMIN_LO__4364C882836D8982", x => x.LOG_ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IMAGE = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false, defaultValue: "NO_IMAGE_AVAILABLE.jpg"),
                    ORDERS = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DESCRIPTION = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CONTENT = table.Column<string>(type: "ntext", nullable: true),
                    IMAGE = table.Column<string>(type: "nvarchar(max)", nullable: true, defaultValue: "NO_IMAGE_AVAILABLE.jpg"),
                    META_TITLE = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TITLE = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    LOGO = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true, defaultValue: "NO_IMAGE_AVAILABLE.jpg"),
                    URL = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ORDERS = table.Column<byte>(type: "tinyint", nullable: true, defaultValue: (byte)1),
                    CREATED_DATE = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "(getdate())"),
                    UPDATED_DATE = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "(getdate())"),
                    ADMIN_CREATED = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ADMIN_UPDATED = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__PARTNER__3214EC27C7B213D2", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DESCRIPTION = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CONTENT = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IMAGE = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true, defaultValue: "NO_IMAGE_AVAILABLE.jpg"),
                    META_TITLE = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    META_KEYWORD = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    META_DESCRIPTION = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    SLUG = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ...
                    LIKES = table.Column<int>(type: "int", nullable: true),
                    STAR = table.Column<double>(type: "float", nullable: true),
                    HOME = table.Column<byte>(type: "tinyint", nullable: true, defaultValue: (byte)0),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__SLIDES__3214EC27B8F03D32", x => x.ID);
                });
        }
