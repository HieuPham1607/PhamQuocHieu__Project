...
namespace Lab7.Areas.Admins.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Name,ProductPrice,ProductSale,Status,CategoryId,CreatedDate,Image,Description")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,Name,ProductPrice,ProductSale,Status,CategoryId,CreatedDate,Image,Description")] Product product)
        {
